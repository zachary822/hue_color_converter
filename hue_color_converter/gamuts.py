...
def get_gamut(model_id: str) -> Polygon:
    if model_id in {"LST001", "LLC005", "LLC006", "LLC007", "LLC010", "LLC011", "LLC012", "LLC013", "LLC014", "A"}:
        return GAMUT_A
    if model_id in {"LCT001", "LCT007", "LCT002", "LCT003", "LLM001", "B"}:
        return GAMUT_B
    if model_id in {"LCT010", "LCT011", "LCT012", "LCT014", "LCT015", "LCT016", "LLC020", "LST002", "C"}:
        return GAMUT_C
